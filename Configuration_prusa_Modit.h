...
// Freddie Hong modifit for Printing electrical traces
...
#define FILAMENTCHANGE_FIRSTFEED 70 //E distance in mm for fast filament loading sequence used used in filament change (M600) ORIGINAL is 70
...
#define FILAMENTCHANGE_EFEED_FIRST 10 // feedrate in mm/s for fast filament loading sequence used in filament change (M600) ORIGINAL IS 20
#define FILAMENTCHANGE_EFEED_FINAL 1.8f // feedrate in mm/s for slow filament loading sequence used in filament change (M600) and filament load (M701)  ORIGINAL IS 3.3
...
#define PP_PREHEAT_HOTEND_TEMP 155
#define PP_PREHEAT_HPB_TEMP 30
